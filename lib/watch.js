...
module.exports = {
  installWatch, removeWatch, watchStatus,
  MACOS_PLIST_PATH, MACOS_LABEL, LOG_PATH,
  // Exported for testing
  resolveCli, buildPlist, buildSystemdUnits,
  installMacOS, removeMacOS, statusMacOS,
  installLinux, removeLinux, statusLinux,
  LINUX_PATH_UNIT, LINUX_SERVICE_UNIT,
};
